    ...
    return (
        <div className="App">
            <Container className="text-center">
                ...
                {menu ? <Articles setArticle={setArticle} setArticleTitle={setArticleTitle} setMenu={setMenu}/> :
                    <Article article={article} articleTitle={articleTitle} setMenu={setMenu}/>}
                    ...
                    <div className="container-fluid">
                        <div className="row align-items-end">
                            ...
                            <div className="col text-right">
                                ...
                                <p className="m-0 font-weight-bold"><a href="https://github.com/axelrodvl/gutenberg"
                                                                       title="gutenberg">gutenberg</a>
                                </p>
                            </div>
                        </div>
                    </div>
